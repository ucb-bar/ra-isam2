...
python3 $SCRIPT_DIR/generate_full_tree_update.py --infile $BUILD_DIR/tree.out --num_update_keys 10 --outfile $HEADER_DIR/full_tree_update_w10000_${num_steps}_${tree_size}.h --seed 0
...
python3 $SCRIPT_DIR/generate_full_tree_update.py --infile $BUILD_DIR/tree.out --num_update_keys 10 --outfile $HEADER_DIR/full_tree_update_sphere2500_${num_steps}_${tree_size}.h --seed 0
