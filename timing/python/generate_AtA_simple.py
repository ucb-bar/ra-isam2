"""
generate_AtA_simple.py
Generate sparse factors A_i involving one or more blocks. Each sparse factor will always involve
the last row. Generate an initial SPD matrix H (only bottom half is stored). The correct
...
Example Commands: 
    python3 generate_AtA_simple.py --num_blocks 20 --block_sizes="3 6 9" --num_factor_vars="2 3" --num_factor 50 --factor_dims="3 6 9" --seed 0 --outfile baremetal_tests/AtA_simple_num_blocks-20_num_factor-50.h
"""
