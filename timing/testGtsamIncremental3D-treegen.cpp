...
int main(int argc, char *argv[]) {
    ...
    static struct option long_options[] = {
        ...
        {"tree_size", required_argument, 0, 50},
        {"tree_outfile", required_argument, 0, 51},
        {0, 0, 0, 0}
    };
    ...
    ofstream fout(tree_outfile);

    if(!fout.is_open()) {
      cerr << "Cannot open file: " << tree_outfile << endl;
      exit(1);
    }

    isam2.extractSubTree(fout, tree_size);
